...
import { registerShipyardTools } from "./shipyard.js";

describe("registerShipyardTools", () => {
  ...
  it("registers without throwing", () => {
    ...
    expect(() => registerShipyardTools(server, client)).not.toThrow();
  });
  ...
  it("can be called multiple times on different servers", () => {
    ...
    expect(() => registerShipyardTools(server1, client)).not.toThrow();
    expect(() => registerShipyardTools(server2, client)).not.toThrow();
  });
});
